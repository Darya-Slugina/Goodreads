import styles from './AdPrefs.module.css';
                ...
                <div className={styles.grRow}>
                    ...
                    <div>
                        <label className={styles.radioButton}>
                            <input type="radio" name="user[allow_behavioral_ads]" checked="checked" id="adprefs" />
                            <label for="adprefs">Show me interest-based ads provided by Goodreads</label>
                        </label>
                        <label className={styles.radioButton}>
                            <input type="radio" name="user[allow_behavioral_ads]"  id="adprefs1"/>
                    ...
                    <p className={styles.marginTopLarge}>
                        If you choose not to be shown interest-based ads above, we will no longer show interest-based ads to you. Even if
                            you choose not to see interest-based ads, you may still see <a href="/user/edit_fav_genres">&nbsp;personalized recommendations&nbsp;</a>
                            and other similar features on Goodreads. You may also see ads provided by Goodreads, they just will not be based
                            on your interests. For more general information, please see our <a href="/privacy">&nbsp;Privacy Notice</a>.
                        </p>
                    <p className={styles.marginTopMedium}>
                        ...
                        be collected for other purposes. You can manage cookies in the privacy settings of the web browser you are using.
                            Further details on how we use cookies and how you can manage cookies are contained in our <a href="/cookies">&nbsp;Cookies Notice&nbsp;</a>.
                        </p>
                    <p className={styles.marginTopMedium}>
                    ...
                    <p className={styles.marginTopMedium}>
                        ...
                        You can generally opt out of receiving personalized ads from third party
                            advertisers and ad networks who are members of the <a href="https://www.networkadvertising.org/choices/">&nbsp;Network Advertising Initiative (NAI)&nbsp;</a>
                            or who follow the <a href="https://www.aboutads.info/choices/">&nbsp;Digital Advertising Alliance's Self-Regulatory Principles for Online Behavioral Advertising&nbsp;</a>
